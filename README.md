...
תקלות שרת וניסיון חוזר, נגישות וניגודיות ותצוגה מקדימה לוואטסאפ. כל אלה לא נוגעים בגיליון האמיתי.
שליחה אמיתית לגיליון רצה רק בבקשה מפורשת – `node run.js real` – ומשאירה שורה בשם "בדיקה מהאתר" (במצב "לא מגיע") שצריך למחוק אחר כך.
